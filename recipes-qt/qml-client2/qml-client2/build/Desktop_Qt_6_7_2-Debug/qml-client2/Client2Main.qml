...
ApplicationWindow {
    ...
    Component.onCompleted: {
        ...
        client2localsocketwrapper.connectToServer("/tmp/opcodeClient2Socket"); // Update with the path used in the compositor
    ...
    function handleOpcode(opcode) {
        ...
        if (opcode === "MOVE_LEFT") {
            ...
            if (buttonGrid.currentIndex === 0 && previousIndex !== 0) {
                ...
                client2localsocketwrapper.sendData("NOT CONSUMED");
                console.log("TABSPACE not consumed, no more focusable items");
            } else {
                // Focus moved forward successfully
                client2localsocketwrapper.sendData("CONSUMED");
